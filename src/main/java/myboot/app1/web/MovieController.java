...
public class MovieController {
	...
	@RequestMapping(value = "/oldmovie")
	private ModelAndView getOldMovies() {
		var res = new ModelAndView("oldmovies");
		res.addObject("OldMovies", dao.findOldMovies());
		return res;
	}
	...
	@RequestMapping(value = "/remove-movie/{id}")
